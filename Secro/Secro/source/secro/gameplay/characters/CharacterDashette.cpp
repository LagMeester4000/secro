...
void secro::CharacterDashette::loadAnimations()
{
	...
	loadAnimation("Dashette-groundDash-animated.png", 24, false, 0.01f, animDash);
	loadAnimation("Dashette-idle.png", 60, true, 0.1f, animStand);
	loadAnimation("Dashette-InAir.png", 1, false, 0.01f, animInAir);
	loadAnimation("Dashette-InAir-animated.png", 20, false, 0.01f, animInAirJump);
	...
	loadAnimation("Dashette-UAir-animated.png", 34, false, 0.013f, animUAir);
	...
	loadAnimation("Dashette-DTilt-new.png", 21, false, 0.01f, animDTilt);
	...
	loadAnimation("Dashette-gethit-animated.png", 19, false, 0.02f, animHitstun);
	loadAnimation("Dashette-FreeFall.png", 1, false, 0.05f, animFreeFall);
	loadAnimation("Dashette-dash-animated.png", 60, false, 0.01f, animSpDash);
